...
import com.example.isafe.Classes.Road9;
...
public class road9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Window window = road9.this.getWindow();
        ...
        window.setStatusBarColor(ContextCompat.getColor(road9.this,R.color.mystatus));
        ...
        save9.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(et1) || TextUtils.isEmpty(et2) || TextUtils.isEmpty(et3) || TextUtils.isEmpty(et4) || TextUtils.isEmpty(et5) || TextUtils.isEmpty(et6) || TextUtils.isEmpty(et7) || TextUtils.isEmpty(et8) || TextUtils.isEmpty(et9) || TextUtils.isEmpty(et10)) {
                    Toast.makeText(road9.this, "Please fill out all fields!", Toast.LENGTH_SHORT).show();
                } else {
                    FirebaseDatabase.getInstance().getReference()
                            ...
                            .child("Checklist9")
                            .push()
                            .setValue(new Road9(et1, et2, et3, et4, et5, et6, et7, et8, et9, et10));
