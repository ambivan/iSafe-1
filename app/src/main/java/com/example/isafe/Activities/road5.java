...
import com.example.isafe.Classes.Road5;
...
public class road5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Window window = road5.this.getWindow();
        ...
        window.setStatusBarColor(ContextCompat.getColor(road5.this,R.color.mystatus));
        ...
        next5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(et1) || TextUtils.isEmpty(et2) || TextUtils.isEmpty(et3) || TextUtils.isEmpty(et4) || TextUtils.isEmpty(et5) || TextUtils.isEmpty(et6) || TextUtils.isEmpty(et7) || TextUtils.isEmpty(et8) || TextUtils.isEmpty(et9) || TextUtils.isEmpty(et10)) {
                    Toast.makeText(road5.this, "Please fill out all fields!", Toast.LENGTH_SHORT).show();
                } else {
