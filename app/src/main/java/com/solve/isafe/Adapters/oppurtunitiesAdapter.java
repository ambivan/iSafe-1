...
public class oppurtunitiesAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int listPosition, final int expandedListPosition,
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(com.solve.isafe.R.layout.opp_child, null);
        ...
        TextView expandedListTextView = (TextView) convertView.findViewById(com.solve.isafe.R.id.expandedListItem);
    ...
    public View getGroupView(int listPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            LayoutInflater layoutInflater = (LayoutInflater) this.context.
                    getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = layoutInflater.inflate(com.solve.isafe.R.layout.opp_headings, null);
        }
        TextView listTitleTextView = (TextView) convertView
                .findViewById(com.solve.isafe.R.id.listTitle);
