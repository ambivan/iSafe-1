...
public class profileAdapter extends RecyclerView.Adapter<profileAdapter.ViewHolder> {
    ...
    public profileAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View listItem= layoutInflater.inflate(com.solve.isafe.R.layout.horizontal_rv, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            this.name  = (TextView) itemView.findViewById(com.solve.isafe.R.id.membername);
            this.profile_pic = (ImageView) itemView.findViewById(com.solve.isafe.R.id.recyclerprofile);
