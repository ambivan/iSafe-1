...
import com.solve.isafe.Adapters.MeetingsAdapter;
import com.solve.isafe.Activities.Agenda_Meeting;
import com.solve.isafe.Activities.ChatMeeting;
import com.solve.isafe.Classes.Meeting;
...
public class Meetings extends Fragment {
  ...
  public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
    ...
    start = (Button) vm.findViewById(com.solve.isafe.R.id.start);
    recyclerView = (RecyclerView) vm.findViewById(com.solve.isafe.R.id.recyclerView4);
