...
public class Attendance extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        vv = inflater.inflate(com.solve.isafe.R.layout.tab2, container, false);

        recyclerView = (RecyclerView) vv.findViewById(com.solve.isafe.R.id.recyclerView2);
        regfirst = (TextView) vv.findViewById(com.solve.isafe.R.id.regfirst);
